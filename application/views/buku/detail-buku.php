            ...
            <div class="col-sm-3 col-md-3">
                <div class="thumbnail" style="height: auto; position: relative; left: 100%; width: 200%;">
                    ...
                    <div class="caption">
                        ...
                        <p> 
                            <?php if ($stok < 1): ?>
                                <button class="btn btn-outline-primary fas fw fa-meteor" disabled>Stok Kosong</button>
                            <?php else: ?>
                                <a class="btn btn-outline-primary fas fw fa-shopping-cart" href="<?= base_url('booking/tambahBooking/' . $id); ?>">Booking</a>
                            <?php endif; ?>
                            <span class="btn btn-outline-secondary fas fw fa-reply" onclick="history.go(-1)">Kembali</span> 
                        </p>
                    </div>
                </div>
            </div>
